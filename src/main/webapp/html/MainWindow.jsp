...
<html lang="en">
  ...
  <body>
    <form action="C:\Users\monic\OneDrive\Documentos\AP7\GEAPrototype\GEA\html\MainWindow.html" >         
                ...
                <div class="container-fluid">                 
                  ...
                  <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style="width:50%;">
                    ...
                    <div class="offcanvas-body">
                      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item ">
                          <a class="nav-link active" aria-current="page" href="#"><img src="../img/icons8-ajustes-90.png" style="width: 30px; height:30px" alt="">Settings</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="#"><img src="../img/icons8-favoritos-100.png" style="width: 30px; height:30px" alt="">Favorites</a>
                        </li>
                        <li class="nav-item">
                  ...
                  <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar_2" aria-labelledby="offcanvasDarkNavbarLabel" style="width:50%;">
                    ...
                    <div class="offcanvas-body">
                      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item ">
                          <a class="nav-link active" aria-current="page" href="#"><img src="../img/densityMaps_2.png" style="width: 30px; height:30px" alt=""> Density</a>
                        </li>
                        <li class="nav-item ">
                          <a class="nav-link active" aria-current="page" href="#"><img src="../img/statistics.png" style="width: 30px; height:30px" alt=""> Statistics</a>
                        </li>
                  ...
                  <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar_4" aria-labelledby="offcanvasDarkNavbarLabel" style="width:50%;">
                    ...
                    <div class="offcanvas-body">
                      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item ">
                          <a class="nav-link active" aria-current="page" href=""><img src="../img/mapstandar.png" style="width: 30px; height:30px" alt=""> Standard</a>
                        </li>
                        <li class="nav-item ">
                          <a class="nav-link active" aria-current="page" href=""><img src="../img/forecastmap.png" style="width: 30px; height:30px" alt=""> Weather</a>
                        </li>
                        <li class="nav-item ">
                          <a class="nav-link active" aria-current="page" href=""><img src="../img/topographic.png" style="width: 30px; height:30px" alt=""> Topografy</a>
                        </li>
                      </ul>
                    </div>
                  </div>  
                  <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar_5" aria-labelledby="offcanvasDarkNavbarLabel" style="width:75%;">
                    <div class="offcanvas-header">                      
                      <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                    </div>                 
                    <div class="offcanvas-body">
